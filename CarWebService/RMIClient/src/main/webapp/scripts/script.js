 ...
 */
function validatePassword(requiredPassword) {
    var confirm = document.getElementById("userPassword");
    var popup = document.getElementById('myPopup');
    if (requiredPassword !== confirm.value) {
...
function hide(){
    var confirm = document.getElementById("myPopup");
